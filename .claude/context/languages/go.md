# Go Standards & Guidelines


## Project Structure & Management

- use a `Makefile` to define various commands/targets.
...
In general, try to utilize the standard library as much as possible.

- **Redis**: For in-memory database storage / caching.
- **GORM**: For Object-relational mapping (ORM)
- **golang-jwt**: For securely transmitting information between parties.
- **fasthttp**: If you need to build a high-performance HTTP server.
